...
class SerializedAttentionRoPE(SerializedAttention):
    def __init__(
        ...
        self.rope3d = RoPE3D(freq=100)  # TODO: make it configurable
    ...
    def forward(self, point):
        ...
        #     )
        if not self.enable_flash:
            self.patch_size = self.patch_size_max  # hack for mem efficient attention (remove patch_size_max dependency)
        ...
        pos = self.get_pos(point, order)[None]
